...
CREATE TABLE IF NOT EXISTS `inmobi_casas`.`usuarios` (
  ...
  `Email` VARCHAR(450) CHARACTER SET 'utf8mb3' NOT NULL,
  `Pass` VARCHAR(1000) CHARACTER SET 'utf8mb3' NOT NULL,
  PRIMARY KEY (`Id`),
...
-- -----------------------------------------------------
-- Table `inmobi_casas`.`pais`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inmobi_casas`.`pais` ;

CREATE TABLE IF NOT EXISTS `inmobi_casas`.`pais` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `inmobi_casas`.`estado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inmobi_casas`.`estado` ;

CREATE TABLE IF NOT EXISTS `inmobi_casas`.`estado` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Nombre` VARCHAR(500) NOT NULL,
  `PaisId` INT NOT NULL,
  PRIMARY KEY (`Id`),
  INDEX `FK_Estado_Pais_idx` (`PaisId` ASC) VISIBLE,
  CONSTRAINT `FK_Estado_Pais`
    FOREIGN KEY (`PaisId`)
    REFERENCES `inmobi_casas`.`pais` (`Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `inmobi_casas`.`municipio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inmobi_casas`.`municipio` ;

CREATE TABLE IF NOT EXISTS `inmobi_casas`.`municipio` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Nombre` VARCHAR(500) NOT NULL,
  `EstadoId` INT NOT NULL,
  PRIMARY KEY (`Id`),
  INDEX `FK_municipio_estado_idx` (`EstadoId` ASC) VISIBLE,
  CONSTRAINT `FK_municipio_estado`
    FOREIGN KEY (`EstadoId`)
    REFERENCES `inmobi_casas`.`estado` (`Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
